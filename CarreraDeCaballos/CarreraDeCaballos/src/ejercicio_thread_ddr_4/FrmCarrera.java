...
import CarreraDeCaballos.Caballo;
import java.util.Observable;
import java.util.Observer;

public class FrmCarrera extends javax.swing.JFrame implements Observer {
//creo un array de hilos (vacio)
    private Thread[] hilos;
    
//Almaceno mi cantidad de caballos (4)
    public FrmCarrera() {
        initComponents();
        hilos = new Thread[4];
    }
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        ...
        this.btnIniciar.setEnabled(false);//Inicialmente deshabilitamos el inicio
        this.lblGanador.setText("");//Inialmente ganador vacio
        
        for (int i = 0; i < hilos.length; i++) {
            Caballo c = new Caballo((i+1)+"");
//Notificamos a los hilos cuando haya una nueva accion            
            c.addObserver(this);
            hilos[i] = new Thread(c);
            hilos[i].start();//Iniciamos los hilos
        }
        
        
        
    }//GEN-LAST:event_btnIniciarActionPerformed
//Para terminar el proceso cuando haya un ganador, por eso necesitamos el array de hilos
    ...
    public void update(Observable o, Object arg) {//
        ...
        Caballo c = (Caballo) o;//casteo
        int porcentaje = (int) arg;
//Podemos hacer el seguimiento del porcentaje de progreso de cada caballo
        switch (c.getNombre()) {
            case "1":
...
//Condicionamos para el ganador
        if(porcentaje>=100){
           terminar();
           this.btnIniciar.setEnabled(true);//Vuelvo a habilitar el inicio
           this.lblGanador.setText("Caballo "+c.getNombre());//Muestro el ganador.
        }
    }
